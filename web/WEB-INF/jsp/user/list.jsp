...
<script language="javascript" src="${pageContext.request.contextPath}/js/jquery_ckeckbox.js"></script>
...
<div id="MainArea">
    ...
    <div class="ItemBlock_Title1" id="userTitle" style="display: none;"><!-- 信息说明 --><div class="ItemBlock_Title1">
        	<img border="0" width="4" height="7" src="${pageContext.request.contextPath}/css/blue/images/item_point.gif"/>用户：<span id="username"></span>
